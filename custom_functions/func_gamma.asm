...
;get the RGB values out of color in de into a spot pointed to by wRGB
GetRGB::
;GetRed:	
...
;write a colors at wRGB into their proper bit placement in de
WriteRGB::
;writeRed:
	ld a, [wRGB + 0]
	ld b, a
...
;writeGreen:
	...
	ld e, a
;writeBlue:
	ld a, [wRGB + 2]	;blue bits are 00011111
...
;This is does gamma conversions of wRGB color values via lookup list.
GammaConv::
	ld hl, wRGB
	ld c, 3
	ld b, 0
...
;Applies the color-mixing matrix to colors at wRGB
...
SetGBCPalIndex::
	...
	ld a, [w2GBCColorControl]	;copy the settings into A
...
.doublespeed
	...
	ld a, [wRogueFlagsBitfield2]	;need to set a flag that skips the $FF80 OAM call in VBLANK
	push af
	set 5, a
...
;	pop bc
	push bc
	ld d, c
	callfar DecrementAllColorsGBC_improved
	pop bc
...
;	pop bc
	push bc
	ld d, c
	callfar IncrementAllColorsGBC_improved
	pop bc
...
BufferAllPokeyellowColorsGBC_helper::
	...
	bit 3, a
	jr z, .doNormal
	callfar BufferAllEnhancedColorsGBC
	ret
.doNormal
	callfar BufferAllPokeyellowColorsGBC
	ret
