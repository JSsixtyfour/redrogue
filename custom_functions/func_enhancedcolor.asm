DEF w2GBCBasePalPointers          EQU $D000 ; NUM_ACTIVE_PALS * 2 = 8 bytes
DEF w2GBCPal                      EQU $D008 ; PAL_SIZE = 8 bytes
DEF w2LastBGP                     EQU $D010 ; 1 byte
DEF w2LastOBP0                    EQU $D011 ; 1 byte
DEF w2LastOBP1                    EQU $D012 ; 1 byte
DEF w2BGPPalsBuffer               EQU $D013 ; NUM_ACTIVE_PALS * PAL_SIZE = 32 bytes
DEF w2UpdateGBCPal_Index          EQU $D033 ; 1 byte
DEF w2GBCColorControl             EQU $D034 ; 1 byte
DEF w2GBCFlags	                  EQU $D035 ; 1 byte has to do with a bunch of menu spacing and stuff
...
; bit 5: 60fps option flag, wUnusedD721 bit 4
...
GBCEnhancedRedrawRowOrColumn::
    ...
    and %11
	jp z, .skip_GBCEnhancedRedrawRowOrColumn
...
;the offset of the correct pointer corresponds to double the value of bits 2, 3, and 4 of the w2GBCColorControl value
