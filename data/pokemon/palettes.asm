MonsterPalettes:
	...
	db PAL_PURPLEMON ; SPINARAK
	db PAL_PURPLEMON ; ARIADOS
	...
	db PAL_BROWNMON  ; PINECO
	db PAL_GRAYMON   ; FORRETRESS
	...
	db PAL_PURPLEMON ; SNEASEL
	db PAL_BROWNMON  ; TEDDIURSA
	db PAL_BROWNMON  ; URSARING
	db PAL_REDMON    ; SLUGMA
	db PAL_REDMON    ; MAGCARGO
	db PAL_BLUEMON   ; SWINUB
	db PAL_BLUEMON   ; PILOSWINE
	db PAL_PINKMON   ; CORSOLA
	db PAL_PURPLEMON ; REMORAID
	db PAL_PURPLEMON ; OCTILLERY
