	...
	; tm/hm learnset - from tmp/kep/data/pokemon/base_stats/crobat.asm, minus
	; WHIRLWIND (not a valid TM/HM move here - KEP's TM list differs from ours)
	...
	db BANK(CrobatPicFront) ; pic bank
