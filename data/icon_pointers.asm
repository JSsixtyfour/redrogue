...
MonPartySpritePointers:
	...
	mon_icon_header PikachuSprite,       12, 4, ICON_PIKACHU << 2
	mon_icon_header ChanseySprite,        0, 4, ICON_CHANSEY << 2
	...
	mon_icon_header PikachuSprite,        0, 4, ICONOFFSET + ICON_PIKACHU << 2
	mon_icon_header ChanseySprite,        0, 4, ICONOFFSET + ICON_CHANSEY << 2
