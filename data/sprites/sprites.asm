...
SpriteSheetPointerTable:
	...
	overworld_sprite VoltorbDecoSprite, 12      ; SPRITE_VOLTORB_DECO
	...
	overworld_sprite OmanyteDecoSprite, 12      ; SPRITE_OMANYTE_DECO
	overworld_sprite SnorlaxDecoSprite, 12      ; SPRITE_SNORLAX_DECO
