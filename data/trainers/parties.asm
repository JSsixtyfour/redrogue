...
MistyData:
	...
	db $FF, 21, PSYDUCK, 18, SEAL, 24, STARMIE, 0
    ...
    ; Fifth Gym
	db $FF, 37, PSYDUCK, 39, STARMIE, 37, SEAL, 43, VAPOREON, 0
	...
	db $FF, 42, GOLDUCK, 40, DUGTRIO, 42, DEWGONG, 47, VAPOREON, 41, STARMIE, 0
	db $FF, 42, OMASTAR, 40, GYARADOS, 47, STARMIE, 41, RAPIDASH, 41, LAPRAS, 0
    ; Eighth Gym
...
LtSurgeData:
	...
	db $FF, 37, VOLTORB, 39, MAGNETON, 37, SEAL, 43, RAICHU, 0
    ; Sixth Gym
	...
	db $FF, 42, MAGNETON, 40, VICTREEBEL, 42, ELECTABUZZ, 47, PORYGON, 41, JOLTEON, 0
	db $FF, 42, RAICHU, 40, ELECTRODE, 47, LICKITUNG, 41, FEAROW, 41, ZAPDOS, 0
    ; Eighth Gym
