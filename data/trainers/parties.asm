...
KogaData:
    ...
    ; Third Gym
	db $FF, 21, ZUBAT, 18, BULBASAUR, 24, VENOMTH, 0
	...
	db $FF, 42, TENTACRUEL, 40, GOLDUCK, 42, VENOMTH, 40, MAGMAR, 47, NIDOKING, 0
    ; Eighth Gym
    db $FF, 45, WEEZING, 42, HYPNO, 44, GENGAR, 45, LAPRAS, 47, SCYTHER, 50, NIDOKING, 0
	db $FF, 45, MUK, 42, MAGMAR, 44, VENUSAUR, 45, RHYDON, 47, TAUROS, 50, NIDOQEEN, 0
...
SabrinaData:
	...
	db $FF, 37, VENOMOTH, 39, HYPNO, 37, HITMONLEE, SLOWBRO, 0
    ; Sixth Gym
