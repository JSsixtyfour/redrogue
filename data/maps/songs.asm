MapSongBanks::
	...
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; REWARD_ROOM AKA UNUSED_MAP_0B
	...
	db MUSIC_MEET_JESSIE_JAMES, BANK(Music_MeetJessieJames) ; OAKS_LAB
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; FLORAS_GROTTO
	...
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETERY_1
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETERY_2
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETERY_3
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_1F
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETERY_4
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; TRUCK
	db MUSIC_GYM, BANK(Music_Gym) ; VIOLET_GYM
	db MUSIC_CITIES1, BANK(Music_Cities1) ; MINI_SAFFRON
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; LANCES_ROOM
	db MUSIC_GYM, BANK(Music_Gym) ; AZALEA_GYM
	db MUSIC_GYM, BANK(Music_Gym) ; GOLDENROD_GYM
	db MUSIC_GYM, BANK(Music_Gym) ; ECRUTEAK_GYM
	db MUSIC_GYM, BANK(Music_Gym) ; CIANWOOD_GYM
	...
	db MUSIC_CELADON, BANK(Music_Cities1) ; CREDIT_EXCHANGE
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; IGAS_DOJO
	...
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; INDIGO_PLATEAU_LOBBY (default; permanently overridden to MUSIC_INDIGO_PLATEAU once BIT_VICTORY_ROAD_CLEARED is set - see scripts/IndigoPlateauLobby.asm)
	...
	db MUSIC_GYM, BANK(Music_Gym) ; OLIVINE_GYM
	db MUSIC_GYM, BANK(Music_Gym) ; MAHOGANY_GYM
	db MUSIC_GYM, BANK(Music_Gym) ; BLACKTHORN_GYM
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ; SILPH_CO_B1F
	db MUSIC_CITIES1, BANK(Music_Cities1) ; SILPH_CO_DORM
	db MUSIC_CELADON, BANK(Music_Celadon) ; TRADE_CENTER
	db MUSIC_CELADON, BANK(Music_Celadon) ; COLOSSEUM
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; PROCEDURAL_CAVE_1 (was UNUSED_MAP_F1)
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; PROCEDURAL_FOREST (was UNUSED_MAP_F2)
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; UNUSED_MAP_F3
	db MUSIC_CITIES1, BANK(Music_Cities1) ; SILPH_CO_VR
