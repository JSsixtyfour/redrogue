MapSongBanks::
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; CREDIT_EXCHANGE
	...
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; SILPH_CO_B1F
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; SILPH_CO_DORM
	...
	db MUSIC_SILPH_CO, BANK(Music_SilphCo) ; SILPH_CO_VR
