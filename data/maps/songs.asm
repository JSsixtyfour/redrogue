MapSongBanks::
	...
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETARY_1
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETARY_2
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETARY_3
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_1F
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; PROCEDURAL_CEMETARY_4
