	...
	const_export SSANNEB1FROOMS_SAILOR
...
SSAnneB1FRooms_Object:
	...
	def_object_events
	object_event  5,  7, SPRITE_GENTLEMAN, STAY, RIGHT, TEXT_SSANNEB1F_GENTLEMAN, OPP_GENTLEMAN, 1
	object_event 10,  7, SPRITE_SAILOR, STAY, LEFT, TEXT_SSANNEB1F_SAILOR_1, OPP_SAILOR, 1
	object_event 15,  7, SPRITE_FISHER, STAY, DOWN, TEXT_SSANNEB1F_FISHER, OPP_FISHER, 1
	object_event 20,  7, SPRITE_SAILOR, STAY, UP, TEXT_SSANNEB1F_SAILOR_2, OPP_SAILOR, 1
