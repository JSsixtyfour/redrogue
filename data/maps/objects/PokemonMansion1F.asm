...
PokemonMansion1F_Object:
	...
	def_object_events
	object_event  7, 19, SPRITE_SCIENTIST,  STAY, LEFT,  TEXT_POKEMONMANSION1F_SCIENTIST,   OPP_SCIENTIST, 1
	object_event  7, 23, SPRITE_SUPER_NERD, STAY, RIGHT, TEXT_POKEMONMANSION1F_SCIENTIST_2, OPP_BURGLAR,   1
	object_event  4, 21, SPRITE_SUPER_NERD, STAY, LEFT,  TEXT_POKEMONMANSION1F_SCIENTIST_3, OPP_BURGLAR,   1
	object_event  4, 17, SPRITE_SCIENTIST,  STAY, DOWN,  TEXT_POKEMONMANSION1F_SCIENTIST_4, OPP_SCIENTIST, 1
