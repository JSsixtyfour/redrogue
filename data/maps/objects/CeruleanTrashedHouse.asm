...
CeruleanTrashedHouse_Object:
	...
	warp_event 13,  1, LAST_MAP, 8

	def_bg_events
	bg_event  4,  0, TEXT_CERULEANTRASHEDHOUSE_WALL_HOLE

	def_object_events
	object_event  4,  1, SPRITE_OFFICER_JENNY, STAY, DOWN, TEXT_CERULEANTRASHEDHOUSE_FISHING_GURU
