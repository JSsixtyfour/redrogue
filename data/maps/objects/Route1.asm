    ...
    const_export ROUTE1_ROGUE_TRADE_NPC
...
Route1_Object:
	...
	def_warp_events
	warp_event 10, 35, WARP_NO_RETURN, 1
	warp_event 11, 35, WARP_NO_RETURN, 1
	...
	object_event 12,  8, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_ROUTE1_ROGUE_TRADE_NPC
