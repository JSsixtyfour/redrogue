    ...
    const_export POWERPLANT_ROGUE_TRADE_NPC
...
PowerPlant_Object:
	...
	object_event  2,  8, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_POWERPLANT_ROGUE_TRADE_NPC
	...
	object_event  4,  5, SPRITE_ZAPDOS,    STAY, UP,   TEXT_POWERPLANT_ZAPDOS,    ZAPDOS,   50 | OW_POKEMON
