...
HiddenEventMaps:
	...
	; MUSEUM_1F removed 2026-09-03 with the fossil displays - HiddenEventPointers
	; is generated by a FOR loop over this same list, so both sides stay in sync.
...
DEF ANY_FACING EQU $d0
	...
	; MUSEUM_1F's two fossil displays were removed 2026-09-03 with the
	; FOSSIL_* pseudo-species; that map is not in Red Rogue's stage pool.
