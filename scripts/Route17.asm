DEF ROUTE17_ALL_TRAINERS_MASK EQU (1 << (EVENT_BEAT_ROUTE_17_TRAINER_0 % 8)) \
	| (1 << (EVENT_BEAT_ROUTE_17_TRAINER_1 % 8)) \
	| (1 << (EVENT_BEAT_ROUTE_17_TRAINER_2 % 8)) \
	| (1 << (EVENT_BEAT_ROUTE_17_TRAINER_3 % 8)) \
	| (1 << (EVENT_BEAT_ROUTE_17_TRAINER_4 % 8))
...
Route17_Script:
    ...
    ld a, [wEventFlags + (EVENT_BEAT_ROUTE_17_TRAINER_0 / 8)]
    and ROUTE17_ALL_TRAINERS_MASK
    cp ROUTE17_ALL_TRAINERS_MASK
    jr nz, .afterRewardCheck
...
Route17_TextPointers:
    ...
    dw_const Route17_Rogue_Reward_Script_PokeballText_1, TEXT_ROUTE17_ROGUE_TRADE_NPC
