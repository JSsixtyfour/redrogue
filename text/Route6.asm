_Route6JrTrainerM1BattleText::
	text "Who's there?"
	line "Quit listening in"
	cont "on us!"
	done

_Route6JrTrainerM1EndBattleText::
	text "I"
	line "just can't win!"
	prompt

_Route6JrTrainerAfterBattleText::
	text "Whisper..."
	line "whisper..."
	done

_Route6JrTrainerF1BattleText::
	text "Excuse me! This"
	line "is a private"
	cont "conversation!"
	done

_Route6JrTrainerF1EndBattleText::
	text "Ugh!"
	line "I hate losing!"
	prompt

_Route6BugCatcherBattleText::
	text "There aren't many"
	line "bugs out here."
	done

_Route6BugCatcherEndBattleText::
	text "No!"
	line "You're kidding!"
	prompt

_Route6BugCatcherAfterBattleText::
	text "I like bugs, so"
...
_Route6JrTrainerF2EndBattleText::
	text "Just"
	line "didn't work!"
	prompt

_Route6JrTrainerF2AfterBattleText::
	text "I want to get"
