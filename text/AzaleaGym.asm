...
_AzaleaGymBugsyReceivedBadgeText::
	text "Whoa, amazing!"
...
_AzaleaGymBugsyPostBattleAdviceText::
	text "Bug #MON are"
	line "deep. There are"
...
_AzaleaGymBugsyWaitTakeThisText::
	text "Here, I also want"
	line "you to have this."
	done

_AzaleaGymReceivedTMText::
...
_AzaleaGymTMNoRoomText::
	text "You have no room"
	line "for this!"
	done

_AzaleaGymTrainer1BattleText::
	text "Bug #MON evolve"
...
_AzaleaGymTrainer3BattleText::
	text "You look strong"
	line "But my grown-up"
	cont "#MON are pretty"
	cont "tough too!"
	done
