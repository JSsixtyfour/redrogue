...
; entries correspond to item ids
	...
	dw UnusableItem      ; ITEM_2C, BIG PEARL
	dw UnusableItem      ; BIKE_VOUCHER
	dw ItemUseXAccuracy  ; X_ACCURACY
	dw ItemUseEvoStone   ; LEAF_STONE
	dw UnusableItem      ; CARD_KEY
	dw UnusableItem      ; NUGGET
	dw UnusableItem      ; BIG NUGGET
...
; Preserve wEnemyMonSpecies2, the original species, when catching a transformed Pokémon.
...
.useVitamin
	...
	ld [wCurSpecies], a
	ld [wPokedexNum], a
	call PublishFormContext ; Phase 2R: hl is still the struct base here
	ld bc, MON_LEVEL
...
; decrement the item ID so that ELIXER becomes ETHER and MAX_ELIXER becomes MAX_ETHER
	...
	ld [wTileBehindCursor], a ; zero the counter for number of moves that had their PP restored
	ld b, 4
...
; INPUT:
; [hWhichPokemon] = index of pokemon in party
; [hCurrentMenuItem] = index of move (when using a PP Up)
RestoreBonusPP:
	ld hl, wPartyMon1Moves
	ld bc, PARTYMON_STRUCT_LENGTH
	ldh a, [hWhichPokemon]
