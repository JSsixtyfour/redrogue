...
; LEVELS, COLORS, FOLLOWER, and 60 FPS. See the ROW_* / NUM_EXTRA_OPTION_ROWS constants
...
; exited.
	...
	ld c, 18
	call TextBoxBorder
	hlcoord 0, 4 ; encloses the six setting rows through row 15
	ld b, 12
	ld c, 18
	call TextBoxBorder
	hlcoord 1, 2
