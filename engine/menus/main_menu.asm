...
; The body of this menu now lives in engine/menus/options_menu.asm, a floating
; section. Only the stub stays here: bank 1 is perpetually near-full and holds
; debug_menu.asm as well, so moving the options out is what paid for the
; redesign. Matches the farjp precedent at InitOptions above and
