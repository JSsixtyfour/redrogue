...
; IsRogueStageMap and RogueStageMapTable live in the rogue bank
; (custom_functions/random_stage_selection.asm) so they share one table.
; NUM_STAGE_MAPS is defined there too.
