...
; Same 93-entry overworld-common SFX suite as AUDIO_1/AUDIO_3 (see
; sfxheaders4.asm's header comment). Order must match sfxheaders4.asm and
; sfxheaders1.asm exactly - the numeric sound ID is derived from position.
