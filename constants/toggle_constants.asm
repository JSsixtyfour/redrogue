...
; after battle and are detected in wToggleableObjectList.)
    ...
    ;const TOGGLE_VIRIDIAN_FOREST_ROGUE_REWARD_POKEBALL_1 ; 67
    ;const TOGGLE_VIRIDIAN_FOREST_ROGUE_REWARD_POKEBALL_2 ; 68
    ;const TOGGLE_VIRIDIAN_FOREST_ROGUE_REWARD_POKEBALL_3 ; 69
