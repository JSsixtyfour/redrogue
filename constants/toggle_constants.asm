...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_POKEMON_TOWER_7F_ROCKET_4
	const TOGGLE_POKEMON_TOWER_7F_ROCKET_5
...
; is safe: nothing outside these two files reads a TOGGLE_* value as a literal.
	...
	const TOGGLE_FACILITY_FAKE_BALL_1  ; slot 6
...
; toggle id shifts; keep this block last in data/maps/toggleable_objects.asm.
	...
	const TOGGLE_SILPH_CO_B1F_LANCE
	const TOGGLE_SILPH_CO_B1F_ROCKET

	toggle_consts_for AI_LAIR
	const TOGGLE_AI_LAIR_OPPONENT

	toggle_consts_for PALMS_ROOM
	const TOGGLE_PALMS_ROOM_PROF_PALM
	const TOGGLE_PALMS_ROOM_LANCE
