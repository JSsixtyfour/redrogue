...
INCLUDE "text/ProceduralCave1.asm"
INCLUDE "text/ProceduralCemetery.asm"
INCLUDE "text/SilphCoB1F.asm"
INCLUDE "text/PalmsRoom.asm"
INCLUDE "text/SilphCoVR.asm"
INCLUDE "text/Truck.asm"
...
INCLUDE "text/CreditExchange.asm"
INCLUDE "text/SilphCoDorm.asm"
