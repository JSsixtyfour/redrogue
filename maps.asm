...
INCLUDE "data/maps/headers/CreditExchange.asm"
INCLUDE "scripts/CreditExchange.asm"
INCLUDE "data/maps/objects/CreditExchange.asm"
CreditExchange_Blocks: INCBIN "maps/CreditExchange.blk"
...
INCLUDE "data/maps/headers/RewardRoom.asm"
